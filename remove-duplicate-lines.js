...
toolSection.innerHTML = `
    <div class="input-area">
        <label for="inputText">Text with Duplicate Lines:</label>
        <textarea id="inputText" rows="8" placeholder="Enter text here..."></textarea>
    </div>
    <div class="buttons-grid">
        <button onclick="convert()" class="btn btn-primary">Remove Duplicates</button>
        <button onclick="clearAll()" class="btn btn-clear">Clear</button>
    </div>
    <div class="output-area">
        <label for="outputText">Unique Lines:</label>
